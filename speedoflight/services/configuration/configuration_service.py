...
class ConfigurationService(BaseService):
    ...
    def _create_default_config(self, config_path: Path) -> None:
        ...
        self._logger.info("Creating default config using (local) Ollama.")
